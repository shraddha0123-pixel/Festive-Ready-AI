...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Festive Quest — Diwali RPG Styling Room" },
      {
        name: "description",
        content:
          "Build your real-world Diwali look like you equip an RPG character: equipment slots, festive inventory and a cinematic dressing chamber.",
      },
      { property: "og:title", content: "Festive Quest — Diwali RPG Styling Room" },
      {
        property: "og:description",
        content: "A gamified festive styling room where you equip your real-world Diwali look.",
      },
